...
#define ECI_CAN_FDR_BTP_8000KB  {0,  8000000,  3,  1,  1,  5}   ///<  8000 KB, SP 80,0% @ingroup CanTypes
#define ECI_CAN_FDR_BTP_10000KB {0, 10000000,  2,  1,  1,  4}   ///< 10000 KB, SP 75,0% @ingroup CanTypes
...
typedef struct
{
  ...
  union
  {
    ...
    {
      DWORD           dwTime;     ///< Time stamp for receive message in [us]
      DWORD           dwMsgId;    ///< CAN message identifier (INTEL8 format)
      ECI_CANMSGINFO  uMsgInfo;   ///< CAN message information (bit field)
