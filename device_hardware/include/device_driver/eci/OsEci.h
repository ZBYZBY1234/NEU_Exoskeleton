...
#include <device_driver/eci/ECI_error.h> // for error definition
...
#define OSECI_DOMAIN_NUM(devid)      (devid  >> 16)
#define OSECI_BUS_NUM(devid)       (((devid) >> 8) & 0xff)
#define OSECI_SLOT_NUM(devid)      (((devid) >> 3) & 0x1f)
#define OSECI_FUNC_NUM(devid)       ((devid) & 0x07)
