...
public:
    Motor_Position(DWORD MotorID[12])
    {
        ...
        */
        //DWORD Active_MotorID[12]  = {0x00, 0x00, 0x00, 0x00, 0x601,0x602,0x603,0x608,0x601,0x602,0x603,0x608};
        Active_MotorID[0] = MotorID[0];
        Active_MotorID[1] = MotorID[1];
        Active_MotorID[2] = MotorID[2];
        Active_MotorID[3] = MotorID[3];
        Active_MotorID[4] = MotorID[4];
        Active_MotorID[5] = MotorID[5];
        Active_MotorID[6] = MotorID[6];
        Active_MotorID[7] = MotorID[7];
        Active_MotorID[8] = MotorID[8];
        Active_MotorID[9] = MotorID[9];
        Active_MotorID[10] = MotorID[10];
        Active_MotorID[11] = MotorID[11];
...
void Motor_Position::PositionControl()
{
    while (scanf("%f",&motor_angle) != EOF)
    {
        ...
        BYTE TX_pos_upper_follow[12][8] = {
            ...
            {0x22,0x7A,0x60,0x00,righthip_ox11,righthip_ox12,righthip_ox13,righthip_ox14},//righthip_ox11,righthip_ox12,righthip_ox13,righthip_ox14},/* left   shoulder肩  */
            {0x22,0x7A,0x60,0x00,righthip_ox11,righthip_ox12,righthip_ox13,righthip_ox14},//righthip_ox11,righthip_ox12,righthip_ox13,righthip_ox14},/* right  shoulder  */
            {0x22,0x7A,0x60,0x00,righthip_ox11,righthip_ox12,righthip_ox13,righthip_ox14},//righthip_ox11,righthip_ox12,righthip_ox13,righthip_ox14},/* left   elbow肘     */
