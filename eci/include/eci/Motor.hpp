...
public:
    Motor_Position(DWORD MotorID[12])
    {
        ...
        */
        ...
        memcpy(Active_MotorID,MotorID,sizeof(MotorID));
        ...
        BYTE TX_pos_upper_follow_temp[12][8] = {
            {0x22,0x40,0x60,0x00,0x0F,0x00,0x00,0x00},/* ENABLE */
            {0x22,0x40,0x60,0x00,0x0F,0x00,0x00,0x00},
            {0x22,0x40,0x60,0x00,0x0F,0x00,0x00,0x00},
            {0x22,0x40,0x60,0x00,0x0F,0x00,0x00,0x00},
        ...
        memcpy(TX_pos_upper_follow,TX_pos_upper_follow_temp,sizeof(TX_pos_upper_follow_temp));
    }
    ~Motor_Position(){};
public:
...
void Motor_Position::PositionControl()
{
    while (scanf("%f",&motor_angle) != EOF)
    {
        ...
        //     {0x22,0x7A,0x60,0x00,0x00,0x00,0x00,0x00},
        //     {0x22,0x7A,0x60,0x00,0x00,0x00,0x00,0x00},
        //     {0x22,0x7A,0x60,0x00,righthip_ox11,righthip_ox12,righthip_ox13,righthip_ox14},
        ...
        //Motive
        //printf("%d %d %d %d",TX_pos_upper_follow[4][4],TX_pos_upper_follow[4][5],TX_pos_upper_follow[4][6],TX_pos_upper_follow[4][7]);
        Can_Tx_Data( hResult, TX_pos_upper_follow_, Move_Lower_MotorID);
        sleep(1);
        Can_Tx_Data( hResult, TX_pos_upper_follow_, Move_Lower_MotorID);
        sleep(1);

        // Can_Tx_Data( hResult, temp, Move_Lower_MotorID);
        // sleep(1);
        // Can_Tx_Data( hResult, temp, Move_Lower_MotorID);
        // sleep(1);
    }
