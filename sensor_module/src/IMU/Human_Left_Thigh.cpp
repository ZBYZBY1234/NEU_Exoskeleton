/* * @Author: Beal.MS
   * @Date: 2021-05-23 22:24:59
   * @Last Modified by:   Beal.MS
   * @Last Modified time: 2021-05-23 22:24:59
   * @Description: 
*/
...
class Human_Left_Thigh : public rclcpp::Node
{
public:
    Human_Left_Thigh()
    : Node("Human_Left_Thigh")
    {
        publisher_ = this->create_publisher<std_msgs::msg::Float64MultiArray>(topic, 10);
        timer_ = this->create_wall_timer(
            0.000000868s,
            std::bind(
                &Human_Left_Thigh::timer_callback,
                this)
        );
    }
...
int  main(int argc, char * argv[])
{
    ...
    rclcpp::spin(std::make_shared<Human_Left_Thigh>());
    rclcpp::shutdown();
}